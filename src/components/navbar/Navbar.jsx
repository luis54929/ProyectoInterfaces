    ...
    <div className="navbar navbar-ligth bg-light shadow-sm">
      <div className="container">
        ...
        <div className="d-flex align-items-center">
          ...
          &nbsp;
          <Link type="button" className="btn btn-outline-primary" to="/Shop">
            Shop
          </Link>
        </div>
        {!user.data ? (
